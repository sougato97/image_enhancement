...
from create_dataset.unprocess.unprocess_no_ccm_wb_gain import *
from create_dataset.process.process_no_ccm_wb_gain import *
...
def main():
  src = '/home/sougato97/Thesis/datasets/LOLdataset/eval15/low/' # specify the folder name
  dest = '/home/sougato97/Thesis/datasets/LOLdataset/v2_no_ccm_wb_gain_eval/low/'
